                ...
                <div class="row">
                 <div class="col-sm-12 col-md-4 col-lg-3">
                     <div class="container cont1">
                        <h1> Search <span style={{fontSize:"1.4em"}}>Doctors</span></h1>
                     </div>
                     ...
                     <div class="container cont3" >
                        ...
                        <div class="checkbox">
                          <label><input type="checkbox" value="" class="inp1"/>Option 1</label>
                        </div>
                        <div class="checkbox">
                          <label><input type="checkbox" value="" class="inp1"/>Option 2</label>
                        </div>
                         <div class="checkbox">
                          <label><input type="checkbox" value="" class="inp1"/>Option 1</label>
                        </div>
                     ...
                     <div class="container cont4">
                        <h1 style={{color:"white"}}>Consultation Fee</h1>
                        <div class="slidecontainer">
                          <input type="range" min="0" max="2000"  class="slider" id="myRange"/>
                        </div>
                     </div>
